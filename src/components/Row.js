...
class Row {
    constructor(grid, rowIndex, x, y, height, columns, data, options) {
        ...
        this.cells = [];
        this.rowHeader = new RowHeader(grid, rowIndex, x, y, ROW_HEADER_WIDTH, height, {
            color: '#495060',
            bgColor: '#f8f8f9',
            borderColor: '#d4d4d4',
            borderWidth: 1
        ...
        for(let i = 0; i < len; i++) {
            ...
            const cell = new Cell(data[column.key], grid, i, rowIndex, everyOffsetX, y, width, this.height, column, options)
