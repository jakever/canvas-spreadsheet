...
class Scroller {
    ...
    reset() {
        ...
        this.horizontalScroller.ratio = this.horizontalScroller.has ? 
            ...
            (tableWidth + SCROLLER_TRACK_SIZE - width) : 0;
        this.verticalScroller.ratio = this.verticalScroller.has ? 
            ...
            (tableHeight + SCROLLER_TRACK_SIZE - height) : 0;
    }
    update(diff, dir) {
        if (dir === 'HORIZONTAL') {
    ...
    setPosition() {
        this.horizontalScroller.x = -parseInt(this.grid.scrollX * this.horizontalScroller.ratio)
        this.verticalScroller.y = -parseInt(this.grid.scrollY * this.verticalScroller.ratio)
    }
    ...
    draw() {
        ...
        if (this.horizontalScroller.has) {
            this.grid.painter.drawLine([
                ...
                borderColor: this.horizontalScroller.move || this.horizontalScroller.focus ? SCROLLER_FOCUS_COLOR : SCROLLER_COLOR,
        ...
        if (this.verticalScroller.has) {
            this.grid.painter.drawLine([
                ...
                borderColor: this.verticalScroller.move || this.verticalScroller.focus ? SCROLLER_FOCUS_COLOR : SCROLLER_COLOR,
                borderWidth: SCROLLER_SIZE,
                lineCap: 'round'
            })
        }
