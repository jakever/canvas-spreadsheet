...
export default {
  ...
  methods: {
    ...
    async getHeaders() {
        ...
        this.headers = data.data.data.headers.map(item => ({
          ...item,
          label: item.field_name,
          property: item.field_key,
          business_type: item.field_key === 'emp_name' ? 'link' : '',
          linkAction: item.field_key === 'emp_name' ? this.linkAction : null,
          cardRender: item.field_key === 'emp_name' ? this.cardRender : null,
        }))
